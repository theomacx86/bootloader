...
#define R_PPC64_TPREL16_HIGHESTA                                               \
  100                               /* half16        (sym+add)@tprel@highesta */
#define R_PPC64_DTPREL16_DS 101     /* half16ds* (sym+add)@dtprel */
#define R_PPC64_DTPREL16_LO_DS 102  /* half16ds        (sym+add)@dtprel@l */
#define R_PPC64_DTPREL16_HIGHER 103 /* half16        (sym+add)@dtprel@higher   \
                                     */
#define R_PPC64_DTPREL16_HIGHERA                                               \
  104 /* half16        (sym+add)@dtprel@highera */
#define R_PPC64_DTPREL16_HIGHEST                                               \
  105 /* half16        (sym+add)@dtprel@highest */
